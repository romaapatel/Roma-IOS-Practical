...
let classVar = DifferenceClass(a: "Hello simform")      //mainValueofClass
var structVar = DiffrenceStruct(a: "Hi")        //mainValue of Structure
let childClass = Child(a: "CHidl")
var classCopyVar = classVar
classVar.a = "Cpiy copy copy"
var structCopyVar = structVar
structCopyVar.a = "OPPPPPPPSss"
print("main output \(classVar.a)")
print("main output \(structVar.a)")
print(classCopyVar.a)
print(structCopyVar.a)
